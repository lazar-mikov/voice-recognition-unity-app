...
namespace IBM.Watson.Examples
{
    public class ExampleAssistantV1 : MonoBehaviour
    {
        ...
        private IEnumerator CreateService()
        {
            ...
            IamAuthenticator authenticator = new IamAuthenticator(apikey: "QUABF6sb94895-l0ecsLST334BJI4L_FTbOqfhGTZgmt");
            ...
            service.SetServiceUrl("https://api.eu-gb.assistant.watson.cloud.ibm.com/instances/deaa6f49-cf2f-4871-b567-0057c3793c05");

            workspaceId = Environment.GetEnvironmentVariable("bd96c94c-a3ed-4a09-989b-0d0e3739e1e4");
